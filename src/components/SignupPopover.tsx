...
export default function SignupPopover() {
  ...
  return (
    <div className="signup-pop" role="complementary" aria-label="Sign up for Sona">
      ...
      <p>Save the people you send to — no more retyping emails. Your notes get a Sona Inbox too.</p>
